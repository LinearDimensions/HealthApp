...
R.L = (t,i,e,s)=>{
    ...
    var t = "wheel"
      , l = "mouse"
      , n = [l + "Wheel", l + "move", "touchmove", "touchstart"]
      , p = -1 !== n.indexOf(e) && {
        passive: !1
    }
      , d = (e === n[0] ? o = "on" + t in r ? t : R.Is.def(r.onmousewheel) ? l + t : "DOMMouseScroll" : "focusOut" === e && (o = R.Snif.isFirefox ? "blur" : "focusout"),
    "a" === i ? "add" : "remove");
    for (let t = 0; t < h; t++)
        a[t][d + "EventListener"](o, s, p)
}
;
const Tab = class {
    constructor() {
...
class SVirtual {
    constructor(t) {
        ...
        R.BM(this, ["fn"]);
        var i = ["mouseWheel", "keydown"];
        for (let t = 0; t < 2; t++)
            R.L(document, "a", i[t], this.fn)
    }
    init(t) {
        this.isX = t.isX
    }
    ...
    resize() {
        ...
        for (let t = 0; t < this.creditsLiL; t++) {
            ...
            var k = this.limitSet(i)
              ...
              , V = k.fromBack ? 0 : e
              , U = k.fromBack ? 0 : 100
              , I = R.G.class("sfx-y", this.creditsLi[t])
              , X = I.length;
            if (!this.isVisible[i]) {
                this.tl[i] = new R.TL;
                for (let t = 0; t < X; t++) {
...
function invert(t, i) {
    ...
    t[9] = o * (H * a + k * g + C * i - (F * a + I * g + z * i)),
    t[10] = o * (P * a + I * n + O * i - (G * a + k * n + D * i)),
    t[11] = o * (E * a + z * n + D * g - (B * a + C * n + O * g)),
    t[12] = o * (P * c + E * v + H * l - (B * v + F * l + G * c)),
    t[13] = o * (z * v + F * r + I * c - (k * c + C * v + H * r)),
    t[14] = o * (k * l + D * v + G * r - (O * v + P * r + I * l)),
    t[15] = o * (O * c + B * r + C * l - (z * l + D * c + E * r)),
    t
}
